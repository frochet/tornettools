...
def generate_tor_config(args, authorities, relays, host_torrc_defaults):
    ...
    for hostname in host_torrc_defaults:
        ...
        __generate_host_torrc(args, host_path, host_torrc_defaults[hostname])
...
def __generate_host_torrc(args, host_path, torrc_defaults):
    with open(f"{host_path}/{TORRC_HOST_FILENAME}", "w") as outf:
        ...
        if args.plugins:
            outf.write(f"PluginsDirectory {host_path}/plugins\n")
